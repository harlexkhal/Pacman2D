...
namespace Esm {
	...
	void Mat4x4::SetToLookAt(Esm::Vec3& campos, Esm::Vec3& object, Esm::Vec3& up)
	{
		this->SetToIdentity();
		Esm::Vec3 CameraDirection;
		Esm::Vec3 CameraUp;
		Esm::Vec3 CameraRight;
		...
		//Transposing The Matrix Straight Away..... Inversting the Camera Matrix. so the Scene Gets to to The movement. not the camera.
